...
save(strcat('SCM_',dataset),'P1','P2','P3','P4','class_number','sig');

save(strcat('..\..\Classification_CSP\SCMs\SCM_',dataset),'P1','P2','P3','P4','class_number','sig');